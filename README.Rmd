...
[![AppVeyor Build Status](https://ci.appveyor.com/api/projects/status/github/rstub/dqmagic?branch=master&svg=true)](https://ci.appveyor.com/project/rstub/dqmagic)
